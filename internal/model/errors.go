...
// IsExpired checks if the short URL has expired based on visit count or time.
...
// CreateReq represents a request to create a shortened URL.
...
func (r *CreateReq) Validate() error {
	...
	if r.CustomCode != "" && len(r.CustomCode) > 64 {
		return fmt.Errorf("custom_code must be at most 64 characters")
	}
	return nil
}
